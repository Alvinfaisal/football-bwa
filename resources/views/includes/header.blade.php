        ...
        <div class="mx-auto flex flex-wrap flex-row items-center justify-between">
            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a class="block cursor-pointer nav-1-2" href="{{ route('pages.clubs') }}">Clubs</a>
                    <a class="block cursor-pointer nav-1-2" href="{{ route('pages.players') }}">Players</a>
                    <a class="block cursor-pointer nav-1-2" href="{{ route('pages.managers') }}">Managers</a>
                    <a class="block cursor-pointer nav-1-2" href="{{ route('pages.stadiums') }}">Stadium</a>
                </nav>
            </div>
